...
**Five real BEFORE/AFTER transformations** (recap, multi-agent rewrite, project-rule codification, security review, performance investigation): see [METAPROMPT-EXAMPLES.md](METAPROMPT-EXAMPLES.md). Each is annotated with what the AFTER catches that the BEFORE would miss.
